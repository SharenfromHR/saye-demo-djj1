...
function SAYEConfigView({ planConfigs, setPlanConfigs }: SAYEConfigViewProps) {
  ...
  const updateDraft = <K extends keyof PlanConfig>(field: K, value: PlanConfig[K]) => {
                ...
                <div className="flex gap-3 text-xs">
                  <label className="inline-flex items-center gap-1">
                    <input
                      ...
                      onChange={() => {
                        ...
                        updateDraft("termMonths", 36 as PlanConfig["termMonths"]);
                      }}
                    />
                    <span>3 years</span>
                  </label>
                  <label className="inline-flex items-center gap-1">
                    <input
                      ...
                      onChange={() => {
                        updateDraft("termYears", 5 as 3 | 5);
                        updateDraft("termMonths", 60 as PlanConfig["termMonths"]);
                      }}
                    />
                    <span>5 years</span>
                  </label>
